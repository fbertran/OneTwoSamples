...
The goal of OneTwoSamples is to introduce an R function one_two_sample()
which can deal with one and two (normal) samples, Ying-Ying Zhang, Yi
Wei (2012) <doi:10.2991/asshm-13.2013.29>. For one normal sample x, the
...
y) and sigma1^2 / sigma2^2 (the ratio of the variances of x and y),
tests whether x and y are from the same population, finds the
correlation coefficient of x and y if x and y have the same length.

## Installation

You can install the released version of OneTwoSamples from
...
You can install the development version of OneTwoSamples from
