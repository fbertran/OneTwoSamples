...
{|Z{0.817}|Z{1.328}Z{0.545}Z{0.783}|Z{1.328}Z{1.021}Z{1.089}Z{1.089}|}\hline
...
\begin{tabularx}{\linewidth}{|Q{0.5}|Q{1.25}|Q{1.25}|}\hline
...
{\setlength{\tabcolsep}{3pt}
\begin{tabularx}{\linewidth}{|Z{0.5}|Q{1.25}|Q{1.25}|}\hline \textbf{One normal
